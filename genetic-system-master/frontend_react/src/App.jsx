...
const LoginPage = ({ onBack }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(error);
            alert("Erro de conexão: Verifique se o backend está rodando na porta 8002");
        }
    };
            ...
            >
                <div className="bg-slate-900/50 backdrop-blur-2xl rounded-none border border-white/10 shadow-2xl p-8 md:p-12">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            className="w-full py-4 mt-4 bg-indigo-600 hover:bg-indigo-500 text-white font-medium tracking-wide rounded-sm shadow-lg shadow-indigo-900/50 transition-all flex items-center justify-center gap-2 group"
                        >
                            <span>{isLogin ? 'Acessar Sistema' : 'Começar Agora'}</span>
